...
namespace weather.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<天气Page>("Shell_天气".GetLocalized(), Symbol.Home));
            _primaryItems.Add(ShellNavigationItem.FromType<关于Page>("Shell_关于".GetLocalized(), Symbol.People));
            _secondaryItems.Add(ShellNavigationItem.FromType<设置Page>("Shell_设置".GetLocalized(), Symbol.Setting));
        }
